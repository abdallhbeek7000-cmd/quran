...
class _SupervisorInboxPageState extends State<SupervisorInboxPage> {
  ...
  // 🚀 كاش (ذاكرة مؤقتة) لحفظ أسماء الموظفين عشان ما نعيد تحميلهم من الداتا بيز عند التمرير
  ...
  // 🎯 دالة ذكية وسريعة لجلب معلومات الطرف الآخر (زميل أو مدير)
  ...
  // 🎯 القائمة السفلية الذكية (المقسومة بالنص) لبدء محادثة جديدة
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    // 🚀 التبويبات الداخلية في القائمة فقط
                    TabBar(
                    ...
                    Expanded(
                      child: TabBarView(
                        children: [
                          _buildStudentsTab(isDark), // قائمة الطلاب
                          _buildStaffTab(isDark),    // قائمة الطاقم
                        ],
                      ),
                    ),
                  ],
  ...
  // 📦 قسم اختيار زميل أو مدير للمراسلة
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          SafeArea(
            // 🚀 جلب كافة المحادثات (الأهالي + الطاقم) وعرضهم معاً
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (!isStaff) {
                          ...
                          return _buildChatTile(
                            ...
                            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => SupervisorChatPage(chatId: chatData['docId'], studentId: chatData['studentId'], studentName: studentName, supervisorId: widget.supervisorId))),
                          );
                        } 
                        // 🔵 تصميم رسالة الطاقم (تستخدم FutureBuilder ذكي جداً عشان يجيب الاسم بلحظة)
                        else {
                          ...
                          return FutureBuilder<Map<String, dynamic>>(
                            ...
                            builder: (context, peerSnap) {
                              ...
                              return _buildChatTile(
                                ...
                                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => StaffChatPage(chatId: chatData['docId'], currentUserId: widget.supervisorId, peerId: peerId, peerName: peerName, peerRole: peerRole))),
                              );
                            },
                          );
                        }
  ...
  // 📦 أداة بناء كرت الدردشة (موحدة للأهالي وللطاقم لتوفير الكود والترتيب)
